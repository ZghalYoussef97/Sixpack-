    ...
    ui(new Ui::Dialog6)
{
    ...
    qry2.first();
                 ...
                 QSqlQuery qry_1;
                 qry_1.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'CARBURANT';");
                 ...
                 qDebug()<<car;
                 QSqlQuery qry_2;
                 qry_2.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'ELECTRECITE';");
                 ...
                 qDebug()<<ele;
                 QSqlQuery qry_3;
                 qry_3.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'COMMUNICATION';");
                 ...
                 qDebug()<<com;
                 QSqlQuery qry_4;
                 qry_4.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'Salaires';");
                 ...
                 qDebug()<<sal;
                 QSqlQuery qry_5;
                 qry_5.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'MAINTENANCEINFO';");
                 ...
                 qDebug()<<minf;
                 QSqlQuery qry_6;
                 qry_6.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'FOURNITUREINFO';");
                 ...
                 QSqlQuery qry_7;
                 qry_7.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'MAINTENANCE';");
                 ...
                 QSqlQuery qry_8;
                 qry_8.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'ENTRETIENV';");
                 qry_8.bindValue(":ID",dd);
                 qry_8.exec();
                 qry_8.first();
                 int env=qry_8.value(0).toInt();
                 QSqlQuery qry_9;
                 qry_9.prepare("SELECT sum(VALEUR) FROM GESTIONDEP WHERE (extract(YEAR from DATE_ENR))  = extract(YEAR from :ID) AND TYPE= 'Loyer';");
