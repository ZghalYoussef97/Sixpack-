    ...
    ui(new Ui::Dialog_4)
{
    ...
    qry2.first();
                 ...
                 QSqlQuery qry_1;
                 qry_1.prepare("SELECT VALEUR FROM GESTIONREV WHERE ID = :ID AND TYPE= 'COMMITIONS_TRANSACTIONS';");
                 ...
                 qDebug()<<car;
                 QSqlQuery qry_2;
                 qry_2.prepare("SELECT VALEUR FROM GESTIONREV WHERE ID = :ID AND TYPE= 'LIVRAISONS';");
                 ...
                 qDebug()<<ele;
                 QSqlQuery qry_3;
                 qry_3.prepare("SELECT VALEUR FROM GESTIONREV WHERE ID = :ID AND TYPE= 'SERVICES_EN_LIGNE';");
                 ...
                 qDebug()<<com;
                 QSqlQuery qry_4;
                 qry_4.prepare("SELECT VALEUR FROM GESTIONREV WHERE ID = :ID AND TYPE= 'TRANSACTION_POSTALE';");
