...
//Constructeur
equipement::equipement(QString type,int dispo)
{
...
//modifier equipement
bool equipement::modifierEquip(QString idequip)
{
    QSqlQuery query;
    query.prepare("UPDATE equipement SET TYPE=:type,DISPO=:dispo WHERE IDEQUIP=:idequip");
